...
app.get("/admin/orders", requireLogin, requireAdmin, AdminController.listOrders);
app.get("/admin/sales", requireLogin, requireAdmin, AdminController.listSellerSales);
